...
public class QPolicy {
	...
	public int getAction(double[] feature, int depth) throws Exception {
		double[] Q = getQArray(feature);
		...
		// 以m_epsilon的概率选择非最优的action
		// epsilon-decreasing greedy
		m_epsilon = 0.4 - Math.ceil(depth / 5) * 0.1;
		// System.out.println(m_epsilon);
